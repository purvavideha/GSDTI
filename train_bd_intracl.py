...
drug_path = 'data/bindingDB/drugs/drugs.csv'
target_path = 'data/bindingDB/targets/targets.csv'
drug_feature_path = 'data/bindingDB/drugs/kpgt_base.npz'
graph_folderpath = 'data/bindingDB/targets/graph'
data_path = 'data/bindingDB/df_less1000.csv'
tanimoto_sim_path = 'data/bindingDB/drugs/drugsim_matrix.npz'
tmscore_path = 'data/bindingDB/targets/target_simmatrix.npz'
...
if __name__ == '__main__':
    ...
    test_dataset=GraphDataset_withsim(validation_df, train_drug_df, train_target_df, train_drug_dict, graph_folderpath)
